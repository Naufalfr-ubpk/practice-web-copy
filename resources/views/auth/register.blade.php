<x-guest-layout>
    ...
    <p class="text-sm text-gray-400 mb-8 translatable" data-id="Bergabung dan nikmati kemudahan reservasi di FoodLumina." data-en="Join us and enjoy the convenience of reservation at FoodLumina.">Bergabung dan nikmati kemudahan reservasi di FoodLumina.</p>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-5">
            ...
            <div class="relative">
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="John Doe" class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition placeholder:text-gray-300 dark:placeholder:text-gray-500">
            </div>
        ...
        <div class="mb-5">
            ...
            <div class="relative">
                ...
                <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="Minimal 8 karakter" class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition placeholder:text-gray-300 dark:placeholder:text-gray-500">
            </div>
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi password" class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition placeholder:text-gray-300 dark:placeholder:text-gray-500">
            </div>
        </div>

        {{-- Submit --}}
        <button type="submit" class="w-full py-3 px-4 bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-white font-bold rounded-xl text-sm transition-all duration-200 shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 translatable" data-id="Daftar Sekarang" data-en="Register Now">
            Daftar Sekarang
        </button>

        <p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            <span class="translatable" data-id="Sudah punya akun?" data-en="Already have an account?">Sudah punya akun?</span>  
            <a href="{{ route('login') }}" class="text-amber-500 hover:text-amber-600 font-semibold transition-colors translatable" data-id="Masuk di sini" data-en="Login here">Masuk di sini</a>
        </p>
    </form>
</x-guest-layout>